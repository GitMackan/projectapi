...
switch($method) {
    ...
    case 'POST':
        ...
        if($job->addJob($data->job, $data->title, $data->start, $data->end)) {
    ...
    case 'PUT':
        ...
        //Om id är skickad   
            ...
            if($job->updateJob($id, $data->job, $data->title, $data->start, $data->end)) {
