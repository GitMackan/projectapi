...
switch($method) {
    ...
    case 'POST':
        ...
        if($site->addSite($data->title, $data->url, $data->info)) {
    ...
    case 'PUT':
        ...
        //Om id är skickad   
            ...
            if($site->updateSite($id, $data->title, $data->url, $data->info)) {
